              ...
              <div className="flex items-center md:gap-2 md:flex-row flex-col">
                <div className="bg-white p-6 rounded-xl shadow-md space-y-4 md:w-1/2">
                  ...
                  {user?.email !== food.donator.email && (
                    <button className="w-full py-2 rounded-lg myBtn text-primary font-medium transition">
                      Request Food
                    </button>
                  )}
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md space-y-4 md:w-1/2 mt-4 md:mt-0">
                  ...
                  <div className="flex items-center gap-2 flex-col">
                    <button
                      className="w-full border border-warning text-accent py-2 rounded-lg transition flex items-center gap-2 justify-center cursor-pointer"
                      onClick={() =>
                        (window.location.href = `mailto:${food.donator.email}`)
                      }
                    >
                      <span>
                        <MdEmail color="#5B532C" size={18} />
                      </span>{" "}
                    ...
                    <button
                      ...
                      className="w-full bg-accent text-white py-2 rounded-lg flex items-center gap-2 justify-center cursor-pointer"
                    >
                      {" "}
                      <span>
